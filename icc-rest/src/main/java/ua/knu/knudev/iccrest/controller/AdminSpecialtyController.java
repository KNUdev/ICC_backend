...
public class AdminSpecialtyController {
    ...
    @Operation(
            ...
            description = "Allows to update a specialty"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Specialty successfully updated",
                    content = @Content(
                            mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = SpecialtyDto.class)
                    )
    ...
    @Operation(
            ...
            description = "Fetches detailed information about a specialty based on the provided sspecialty ID"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
